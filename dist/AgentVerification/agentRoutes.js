...
agentVerificationRoutes.post('/verifications', authenticate, (c) => agentVerificationControllers.createVerification(c));
...
agentVerificationRoutes.put('/verifications/:verificationId', authenticate, authorize('ADMIN'), (c) => agentVerificationControllers.updateVerification(c));
// Admin approves a verification (convenience endpoint)
agentVerificationRoutes.post('/verifications/:verificationId/approve', authenticate, authorize('ADMIN'), (c) => agentVerificationControllers.approveVerification(c));
// Admin rejects a verification (convenience endpoint)
agentVerificationRoutes.post('/verifications/:verificationId/reject', authenticate, authorize('ADMIN'), (c) => agentVerificationControllers.rejectVerification(c));
...
agentVerificationRoutes.post('/verifications/bulk/reject', authenticate, authorize('ADMIN'), (c) => agentVerificationControllers.bulkRejectVerifications(c));
// =============================================
// TEST/AUTH ROUTES
// =============================================
// Test authentication
agentVerificationRoutes.get('/verifications/test-auth', authenticate, (c) => agentVerificationControllers.testAuth(c));
// =============================================
// LEGACY/COMPATIBILITY ROUTES
// =============================================
// Backward compatibility route with auto-approve functionality
agentVerificationRoutes.post('/verifications/admin/create-legacy', authenticate, authorize('ADMIN'), async (c) => {
    try {
        ...
        if (body.autoApprove) {
            ...
            if (adminId) {
                const approvedVerification = await agentVerificationService.approveVerification(verification.VerificationId, adminId, body.reviewNotes || 'Automatically approved by admin');
