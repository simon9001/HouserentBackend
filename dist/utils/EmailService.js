...
export class EmailService {
    ...
    static async sendEmail(to, subject, htmlContent, textContent, senderName) {
        const emailData = {
            sender: {
    ...
    static getVerificationEmailHtml(_email, token, username) {
        const verificationLink = `${env.FRONTEND_URL}/verify-email-success?token=${token}`;
        return `
            <!DOCTYPE html>
            <html>
    ...
    static getVerificationEmailText(_email, token, username) {
        const verificationLink = `${env.FRONTEND_URL}/verify-email-success?token=${token}`;
    ...
    static getPasswordResetEmailHtml(_email, token) {
        const resetLink = `${env.FRONTEND_URL}/reset-password?token=${token}`;
        return `
            <!DOCTYPE html>
            <html>
    ...
    static getPasswordResetEmailText(_email, token) {
        const resetLink = `${env.FRONTEND_URL}/reset-password?token=${token}`;
    ...
    static getWelcomeEmailHtml(_email, username) {
        return `
            <!DOCTYPE html>
            <html>
            <head>
    ...
    static getWelcomeEmailText(_email, username) {
