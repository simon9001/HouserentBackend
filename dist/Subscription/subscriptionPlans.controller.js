...
export const createSubscriptionPlan = async (c) => {
    try {
...
// Get plan by ID
export const getSubscriptionPlanById = async (c) => {
    try {
...
// Get all plans
export const getAllSubscriptionPlans = async (c) => {
    try {
...
export const updateSubscriptionPlan = async (c) => {
    try {
        ...
        if (body.basePrice !== undefined)
            updateData.basePrice = parseFloat(body.basePrice);
        ...
        if (body.highlightFeatures !== undefined)
            updateData.highlightFeatures = body.highlightFeatures;
...
export const deleteSubscriptionPlan = async (c) => {
    try {
        const planId = c.req.param('planId');
        if (!ValidationUtils.isValidUUID(planId)) {
            return c.json({
...
// Compare plans
export const compareSubscriptionPlans = async (c) => {
    try {
...
//# sourceMappingURL=subscriptionPlans.controller.js.map