...
export class UsersService {
    ...
    async updateUser(userId, data) {
        ...
        if (data.trustScore !== undefined)
            updates.TrustScore = data.trustScore;
    ...
    async getUserStatistics() {
        ...
        try {
            const [{ count: totalUsers }, { count: activeUsers }, { count: tenants }, { count: agents }, { count: admins }, { count: pendingAgents }, { count: suspendedUsers }, { count: verifiedEmails }] = await Promise.all([
