...
export class CloudinaryService {
        ...
        return new Promise((resolve, reject) => {
          const uploadStream = cloudinary.uploader.upload_stream(
            ...
            (error, result) => {
              ...
              else resolve(this.formatResult(result!));
            }
          );
   ...
   */
  static generateSignedUploadUrl(folder?: string): { url: string; signature: string; timestamp: number; apiKey: string; cloudName: string } {
   ...
   */
  private static getResourceType(mimeType: string): 'image' | 'video' | 'raw' {
   ...
   */
  private static formatResult(result: any): CloudinaryUploadResult {
   ...
   */
  private static getResourceTypeFromResourceType(resourceType: string): 'IMAGE' | 'VIDEO' | 'DOCUMENT' {
    switch (resourceType) {
