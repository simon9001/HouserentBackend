...
// Check if following
export const checkFollowing = async (c: Context) => {
    try {
        const followerId = c.req.param('followerId');
        const followedId = c.req.param('followedId');
...
export const getFollowStats = async (c: Context) => {
    try {
        const userId = c.req.param('userId');
...
// Get mutual follows
export const getMutualFollows = async (c: Context) => {
    try {
...
// Get suggested users
export const getSuggestedUsers = async (c: Context) => {
    try {
        const userId = c.req.param('userId');
