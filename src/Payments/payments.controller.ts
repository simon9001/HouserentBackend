...
import { paymentsService, CreatePaymentInput, UpdatePaymentInput } from './payments.service.js';
...
export const getPaymentsByPropertyId = async (c: Context) => {
    try {
...
export const updatePayment = async (c: Context) => {
    try {
        ...
        if (body.providerReference !== undefined) updateData.providerReference = body.providerReference;
...
// Complete payment
export const completePayment = async (c: Context) => {
    try {
        const paymentId = c.req.param('paymentId');
...
// Fail payment
export const failPayment = async (c: Context) => {
    try {
        const paymentId = c.req.param('paymentId');
        const body = await c.req.json();
...
export const getPaymentStatistics = async (c: Context) => {
    try {
...
// Get recent payments
export const getRecentPayments = async (c: Context) => {
    try {
...
// Search payments
export const searchPayments = async (c: Context) => {
    try {
