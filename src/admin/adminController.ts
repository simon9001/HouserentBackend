...
// Get user analytics
export const getUserAnalytics = async (c: Context) => {
    try {
...
export const getPropertyAnalytics = async (c: Context) => {
    try {
        const days = parseInt(c.req.query('days') || '30');
...
export const getRevenueAnalytics = async (c: Context) => {
    try {
        const days = parseInt(c.req.query('days') || '30');
...
export const getPopularLocations = async (c: Context) => {
    try {
...
export const getSubscriptionGrowth = async (c: Context) => {
    try {
...
// Get churn analytics
export const getChurnAnalytics = async (c: Context) => {
    try {
        const days = parseInt(c.req.query('days') || '30');
...
// Get expiring trials
export const getExpiringTrials = async (c: Context) => {
    try {
...
export const getExpiringSubscriptions = async (c: Context) => {
    try {
        const days = parseInt(c.req.query('days') || '7');
...
export const getSubscriptionInvoices = async (c: Context) => {
    try {
        const page = parseInt(c.req.query('page') || '1');
        const limit = parseInt(c.req.query('limit') || '20');
        const status = c.req.query('status') || undefined;
...
export const getSubscriptionEvents = async (c: Context) => {
    try {
        const page = parseInt(c.req.query('page') || '1');
        const limit = parseInt(c.req.query('limit') || '20');
...
export const getSubscriptionUsageLogs = async (c: Context) => {
    try {
        const page = parseInt(c.req.query('page') || '1');
        const limit = parseInt(c.req.query('limit') || '20');
        const userId = c.req.query('userId') || undefined;
...
export const reactivateSubscription = async (c: Context) => {
    try {
        const body = await c.req.json();
...
export const getSubscriptionUserDetails = async (c: Context) => {
    try {
        const userId = c.req.query('userId') || undefined;
...
export const getSubscriptionPaymentHistory = async (c: Context) => {
    try {
        const subscriptionId = c.req.query('subscriptionId') || undefined;
        const userId = c.req.query('userId') || undefined;
...
export const getQuickStats = async (c: Context) => {
    try {
        const [
            stats,
            activities,
...
// System overview
export const getSystemOverview = async (c: Context) => {
    try {
        const [
            stats,
            roleSummary,
...
export const getSubscriptionHealthCheck = async (c: Context) => {
    try {
