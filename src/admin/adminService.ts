...
export const getSubscriptionInvoicesService = async (
    page: number = 1,
    limit: number = 20,
    status?: string,
    userId?: string
): Promise<{ invoices: SubscriptionInvoice[]; total: number }> => {
    const db = await getDbPool();
...
export const getSubscriptionEventsService = async (
    page: number = 1,
    limit: number = 20,
    eventType?: string,
    processed?: string
...
export const getSubscriptionUsageLogsService = async (
    page: number = 1,
    limit: number = 20,
    userId?: string,
    feature?: string,
...
export const reactivateSubscriptionService = async (
    subscriptionId: string,
    newPlanId?: string,
    startDate?: Date,
    price?: number,
...
export const overrideSubscriptionLimitsService = async (
    subscriptionId: string,
...
export const sendSubscriptionNotificationService = async (
    subscriptionId: string,
...
export const getSubscriptionUserDetailsService = async (
    userId?: string,
    subscriptionId?: string
): Promise<SubscriptionUserDetails> => {
    const db = await getDbPool();
