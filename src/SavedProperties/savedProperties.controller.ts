...
export const saveProperty = async (c: Context) => {
    try {
...
export const unsaveProperty = async (c: Context) => {
    try {
        const userId = c.req.param('userId');
...
export const getSavedPropertiesByUserId = async (c: Context) => {
    try {
        const userId = c.req.param('userId');
...
export const isPropertySaved = async (c: Context) => {
    try {
        const userId = c.req.param('userId');
        const propertyId = c.req.param('propertyId');
